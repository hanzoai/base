...
<Accordion single>
    ...
    <div class="content m-b-sm">
        <p>
            When the application is deployed on platforms like Fly or it is accessible through proxies such as
        ...
        <p>
            ...
            properly configure your proxy and list below the trusted headers that the application could use to
            extract the user IP.
        </p>
        ...
        <ul class="m-t-0 txt-bold">
            ...
            <li>make sure that the server can be accessed only through the proxy</li>
        </ul>
        <p>You can clear the headers field if the application is not deployed behind a proxy.</p>
    </div>
