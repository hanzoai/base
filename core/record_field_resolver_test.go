...
func TestRecordFieldResolverUpdateQuery(t *testing.T) {
	...
	scenarios := []struct {
	...
	}{
		{
			...
			false,
			"SELECT `demo4`.* FROM `demo4` WHERE ([[demo4.title]] = 1 OR [[demo4.title]] IS DISTINCT FROM {:TEST} OR [[demo4.title]] LIKE {:TEST} ESCAPE '\\' OR [[demo4.title]] NOT LIKE {:TEST} ESCAPE '\\' OR [[demo4.title]] > {:TEST} OR [[demo4.title]] >= {:TEST} OR [[demo4.title]] < {:TEST} OR [[demo4.title]] <= {:TEST})",
		},
		{
		...
		},
		{
			...
			false,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each((CASE WHEN json_valid([[demo4.self_rel_many]]) AND json_type([[demo4.self_rel_many]]) = 'array' THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END)) `__je_demo4_self_rel_many` ON 1=1 LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] WHERE [[demo4_self_rel_many.id]] > 1",
		},
		{
		...
		},
		{
			...
			false,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo3` `demo4_rel_one_cascade` ON [[demo4_rel_one_cascade.id]] = [[demo4.rel_one_cascade]] WHERE ((([[demo4_rel_one_cascade.id]] = '' OR [[demo4_rel_one_cascade.id]] IS NULL) OR ({:fTEST} IS DISTINCT FROM '' AND {:fTEST} IS DISTINCT FROM {:tTEST}))) AND ([[demo4_rel_one_cascade.created]] > 1)",
		},
		{
		...
		},
		{
			...
			"rel_many.created ?> true",
			true,
			"SELECT DISTINCT `demo1`.* FROM `demo1` LEFT JOIN json_each((CASE WHEN json_valid([[demo1.rel_many]]) AND json_type([[demo1.rel_many]]) = 'array' THEN [[demo1.rel_many]] ELSE json_array([[demo1.rel_many]]) END)) `__je_demo1_rel_many` ON 1=1 LEFT JOIN `users` `demo1_rel_many` ON [[demo1_rel_many.id]] = [[__je_demo1_rel_many.value]] WHERE [[demo1_rel_many.created]] > 1",
		},
		{
		...
		},
		{
			...
			false,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo4` `demo4_self_rel_one` ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN `demo3` `demo4_self_rel_one_rel_one_cascade` ON [[demo4_self_rel_one_rel_one_cascade.id]] = [[demo4_self_rel_one.rel_one_cascade]] WHERE ((([[demo4_self_rel_one_rel_one_cascade.id]] = '' OR [[demo4_self_rel_one_rel_one_cascade.id]] IS NULL) OR ({:fTEST} IS DISTINCT FROM '' AND {:fTEST} IS DISTINCT FROM {:tTEST}))) AND ([[demo4_self_rel_one_rel_one_cascade.created]] > 1)",
		},
		{
			...
			false,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo4` `demo4_self_rel_one` ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN `demo3` `demo4_self_rel_one_rel_one_cascade` ON [[demo4_self_rel_one_rel_one_cascade.id]] = [[demo4_self_rel_one.rel_one_cascade]] WHERE ((([[demo4_self_rel_one_rel_one_cascade.id]] = '' OR [[demo4_self_rel_one_rel_one_cascade.id]] IS NULL) OR ({:fTEST} IS DISTINCT FROM '' AND {:fTEST} IS DISTINCT FROM {:tTEST}))) AND (([[demo4_self_rel_one_rel_one_cascade.created]] > 1 AND [[demo4_self_rel_one_rel_one_cascade.updated]] > 1))",
		},
		{
		...
		},
		{
			...
			false,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each((CASE WHEN json_valid([[demo4.self_rel_many]]) AND json_type([[demo4.self_rel_many]]) = 'array' THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END)) `__je_demo4_self_rel_many` ON 1=1 LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] LEFT JOIN `demo4` `demo4_self_rel_many_self_rel_one` ON [[demo4_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many.self_rel_one]] WHERE [[demo4_self_rel_many_self_rel_one.title]] > 1",
		},
		{
		...
		},
		{
			...
			false,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each((CASE WHEN json_valid([[demo4.self_rel_many]]) AND json_type([[demo4.self_rel_many]]) = 'array' THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END)) `__je_demo4_self_rel_many` ON 1=1 LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] LEFT JOIN `demo4` `demo4_self_rel_many_self_rel_one` ON [[demo4_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many.self_rel_one]] LEFT JOIN json_each((CASE WHEN json_valid([[demo4_self_rel_many_self_rel_one.self_rel_many]]) AND json_type([[demo4_self_rel_many_self_rel_one.self_rel_many]]) = 'array' THEN [[demo4_self_rel_many_self_rel_one.self_rel_many]] ELSE json_array([[demo4_self_rel_many_self_rel_one.self_rel_many]]) END)) `__je_demo4_self_rel_many_self_rel_one_self_rel_many` ON 1=1 LEFT JOIN `demo4` `demo4_self_rel_many_self_rel_one_self_rel_many` ON [[demo4_self_rel_many_self_rel_one_self_rel_many.id]] = [[__je_demo4_self_rel_many_self_rel_one_self_rel_many.value]] LEFT JOIN `demo4` `demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one` ON [[demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many_self_rel_one_self_rel_many.self_rel_one]] WHERE [[demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one.title]] > 1",
		},
		{
		...
		},
		{
			...
			false,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each((CASE WHEN json_valid([[demo4.self_rel_many]]) AND json_type([[demo4.self_rel_many]]) = 'array' THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END)) `__je_demo4_self_rel_many` ON 1=1 LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] LEFT JOIN `demo4` `demo4_self_rel_one` ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] WHERE ([[demo4_self_rel_many.title]] = {:TEST} OR (CASE WHEN json_valid([[demo4_self_rel_one.json_object]]) THEN JSON_EXTRACT([[demo4_self_rel_one.json_object]], '$.a') ELSE JSON_EXTRACT(json_object('base', [[demo4_self_rel_one.json_object]]), '$.base.a') END) > 1)",
		},
		{
		...
		},
		{
			...
			false,
			"SELECT DISTINCT `demo3`.* FROM `demo3` LEFT JOIN `demo4` `demo3_demo4_via_rel_many_cascade` ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM json_each((CASE WHEN json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) AND json_type([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) = 'array' THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END)) {{__je_demo3_demo4_via_rel_many_cascade}}) WHERE [[demo3_demo4_via_rel_many_cascade.id]] = 1",
		},
		{
			...
			"demo4_via_rel_many_cascade.id = true",
			false,
			"SELECT DISTINCT `demo3`.* FROM `demo3` LEFT JOIN `demo4` `demo3_demo4_via_rel_many_cascade` ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM json_each((CASE WHEN json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) AND json_type([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) = 'array' THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END)) {{__je_demo3_demo4_via_rel_many_cascade}}) WHERE ((([[demo3_demo4_via_rel_many_cascade.id]] = 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_many_cascade.id]] as [[multiMatchValue]] FROM `demo3` `__mm_demo3` LEFT JOIN `demo4` `__mm_demo3_demo4_via_rel_many_cascade` ON [[__mm_demo3.id]] IN (SELECT [[__je___mm_demo3_demo4_via_rel_many_cascade.value]] FROM json_each((CASE WHEN json_valid([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) AND json_type([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) = 'array' THEN [[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END)) {{__je___mm_demo3_demo4_via_rel_many_cascade}}) WHERE `__mm_demo3`.`id` = `demo3`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = 1)))))",
		},
		{
		...
		},
		{
			...
			"view1_via_rel_one.rel_many.created ?> true",
			true,
			"SELECT DISTINCT `demo1`.* FROM `demo1` LEFT JOIN `view1` `demo1_view1_via_rel_one` ON [[demo1_view1_via_rel_one.rel_one]] = [[demo1.id]] LEFT JOIN json_each((CASE WHEN json_valid([[demo1_view1_via_rel_one.rel_many]]) AND json_type([[demo1_view1_via_rel_one.rel_many]]) = 'array' THEN [[demo1_view1_via_rel_one.rel_many]] ELSE json_array([[demo1_view1_via_rel_one.rel_many]]) END)) `__je_demo1_view1_via_rel_one_rel_many` ON 1=1 LEFT JOIN `users` `demo1_view1_via_rel_one_rel_many` ON [[demo1_view1_via_rel_one_rel_many.id]] = [[__je_demo1_view1_via_rel_one_rel_many.value]] WHERE [[demo1_view1_via_rel_one_rel_many.created]] > 1",
		},
		{
			...
			false,
			"SELECT DISTINCT `demo3`.* FROM `demo3` LEFT JOIN `demo4` `demo3_demo4_via_rel_many_cascade` ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM json_each((CASE WHEN json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) AND json_type([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) = 'array' THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END)) {{__je_demo3_demo4_via_rel_many_cascade}}) LEFT JOIN `demo3` `demo3_demo4_via_rel_many_cascade_rel_one_cascade` ON [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] = [[demo3_demo4_via_rel_many_cascade.rel_one_cascade]] LEFT JOIN `demo4` `demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade` ON [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.value]] FROM json_each((CASE WHEN json_valid([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]) AND json_type([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]) = 'array' THEN [[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]] ELSE json_array([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]) END)) {{__je_demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade}}) WHERE ((([[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] = '' OR [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] IS NULL) OR ({:fTEST} IS DISTINCT FROM '' AND {:fTEST} IS DISTINCT FROM {:tTEST}))) AND ([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.id]] = 1)",
		},
		{
		...
		},
		{
			...
			true,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo1` `__collection_demo1` ON 1=1 LEFT JOIN `demo2` `__collection_demo2` ON 1=1 LEFT JOIN `demo1` `__collection_alias_demo1_alias` ON 1=1 WHERE ([[__collection_demo1.text]] > 1 OR [[__collection_demo2.active]] > 1 OR [[__collection_alias_demo1_alias.file_one]] > 1)",
		},
		{
		...
		},
		{
			...
			"@collection.demo3.title > true",
			true,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo3` `__collection_demo3` ON 1=1 WHERE ((([[__collection_demo3.title]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___collection_demo3.title]] as [[multiMatchValue]] FROM `demo4` `__mm_demo4` LEFT JOIN `demo3` `__mm___collection_demo3` ON 1=1 WHERE `__mm_demo4`.`id` = `demo4`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))))",
		},
		{
			...
			"@request.body.rel_one:lower > true ||" +
				...
				"created:lower > true",
			true,
			"SELECT DISTINCT `demo1`.* FROM `demo1` LEFT JOIN `users` `__data_users_rel_many` ON [[__data_users_rel_many.id]] IN ({:p0}, {:p1}) LEFT JOIN json_each((CASE WHEN json_valid([[demo1.rel_many]]) AND json_type([[demo1.rel_many]]) = 'array' THEN [[demo1.rel_many]] ELSE json_array([[demo1.rel_many]]) END)) `__je_demo1_rel_many` ON 1=1 LEFT JOIN `users` `demo1_rel_many` ON [[demo1_rel_many.id]] = [[__je_demo1_rel_many.value]] WHERE (LOWER({:infoLowerrel_oneTEST}) > 1 OR LOWER({:infoLowerrel_manyTEST}) > 1 OR ((LOWER([[__data_users_rel_many.email]]) > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT LOWER([[__mm___data_users_rel_many.email]]) as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN `users` `__mm___data_users_rel_many` ON [[__mm___data_users_rel_many.id]] IN ({:p4}, {:p5}) WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) OR LOWER([[demo1.text]]) > 1 OR LOWER([[demo1.bool]]) > 1 OR LOWER([[demo1.url]]) > 1 OR LOWER([[demo1.select_one]]) > 1 OR LOWER([[demo1.select_many]]) > 1 OR LOWER([[demo1.file_one]]) > 1 OR LOWER([[demo1.file_many]]) > 1 OR LOWER([[demo1.number]]) > 1 OR LOWER([[demo1.email]]) > 1 OR LOWER([[demo1.datetime]]) > 1 OR LOWER((CASE WHEN json_valid([[demo1.json]]) THEN JSON_EXTRACT([[demo1.json]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo1.json]]), '$.base') END)) > 1 OR LOWER([[demo1.rel_one]]) > 1 OR LOWER([[demo1.rel_many]]) > 1 OR ((LOWER([[demo1_rel_many.name]]) > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT LOWER([[__mm_demo1_rel_many.name]]) as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.rel_many]]) AND json_type([[__mm_demo1.rel_many]]) = 'array' THEN [[__mm_demo1.rel_many]] ELSE json_array([[__mm_demo1.rel_many]]) END)) `__mm_demo1_rel_many_je` ON 1=1 LEFT JOIN `users` `__mm_demo1_rel_many` ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) OR LOWER([[demo1.created]]) > 1)",
		},
		{
		...
		},
		{
			...
			"@request.body.select_one:each > true &&" +
				...
				"@request.body.rel_many:each ?< true",
			false,
			"SELECT DISTINCT `demo1`.* FROM `demo1` LEFT JOIN json_each((CASE WHEN json_valid({:dataEachTEST}) AND json_type({:dataEachTEST}) = 'array' THEN {:dataEachTEST} ELSE json_array({:dataEachTEST}) END)) `__dataEach_je_select_one` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid({:dataEachTEST}) AND json_type({:dataEachTEST}) = 'array' THEN {:dataEachTEST} ELSE json_array({:dataEachTEST}) END)) `__dataEach_je_select_many` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid({:dataEachTEST}) AND json_type({:dataEachTEST}) = 'array' THEN {:dataEachTEST} ELSE json_array({:dataEachTEST}) END)) `__dataEach_je_file_one` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid({:dataEachTEST}) AND json_type({:dataEachTEST}) = 'array' THEN {:dataEachTEST} ELSE json_array({:dataEachTEST}) END)) `__dataEach_je_file_many` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid({:dataEachTEST}) AND json_type({:dataEachTEST}) = 'array' THEN {:dataEachTEST} ELSE json_array({:dataEachTEST}) END)) `__dataEach_je_rel_one` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid({:dataEachTEST}) AND json_type({:dataEachTEST}) = 'array' THEN {:dataEachTEST} ELSE json_array({:dataEachTEST}) END)) `__dataEach_je_rel_many` ON 1=1 WHERE ([[__dataEach_je_select_one.value]] > 1 AND [[__dataEach_je_select_one.value]] < 1 AND (([[__dataEach_je_select_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___dataEach_je_select_many.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid({:mmdataEachTEST}) AND json_type({:mmdataEachTEST}) = 'array' THEN {:mmdataEachTEST} ELSE json_array({:mmdataEachTEST}) END)) `__mm___dataEach_je_select_many` ON 1=1 WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__dataEach_je_select_many.value]] < 1 AND [[__dataEach_je_file_one.value]] > 1 AND [[__dataEach_je_file_one.value]] < 1 AND (([[__dataEach_je_file_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___dataEach_je_file_many.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid({:mmdataEachTEST}) AND json_type({:mmdataEachTEST}) = 'array' THEN {:mmdataEachTEST} ELSE json_array({:mmdataEachTEST}) END)) `__mm___dataEach_je_file_many` ON 1=1 WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__dataEach_je_file_many.value]] < 1 AND [[__dataEach_je_rel_one.value]] > 1 AND [[__dataEach_je_rel_one.value]] < 1 AND (([[__dataEach_je_rel_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___dataEach_je_rel_many.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid({:mmdataEachTEST}) AND json_type({:mmdataEachTEST}) = 'array' THEN {:mmdataEachTEST} ELSE json_array({:mmdataEachTEST}) END)) `__mm___dataEach_je_rel_many` ON 1=1 WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__dataEach_je_rel_many.value]] < 1)",
		},
		{
			...
			"select_one:each > true &&" +
				...
				"rel_many:each ?< true",
			false,
			"SELECT DISTINCT `view1`.* FROM `view1` LEFT JOIN json_each((CASE WHEN json_valid([[view1.select_one]]) AND json_type([[view1.select_one]]) = 'array' THEN [[view1.select_one]] ELSE json_array([[view1.select_one]]) END)) `__je_view1_select_one` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid([[view1.select_many]]) AND json_type([[view1.select_many]]) = 'array' THEN [[view1.select_many]] ELSE json_array([[view1.select_many]]) END)) `__je_view1_select_many` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid([[view1.file_one]]) AND json_type([[view1.file_one]]) = 'array' THEN [[view1.file_one]] ELSE json_array([[view1.file_one]]) END)) `__je_view1_file_one` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid([[view1.file_many]]) AND json_type([[view1.file_many]]) = 'array' THEN [[view1.file_many]] ELSE json_array([[view1.file_many]]) END)) `__je_view1_file_many` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid([[view1.rel_one]]) AND json_type([[view1.rel_one]]) = 'array' THEN [[view1.rel_one]] ELSE json_array([[view1.rel_one]]) END)) `__je_view1_rel_one` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid([[view1.rel_many]]) AND json_type([[view1.rel_many]]) = 'array' THEN [[view1.rel_many]] ELSE json_array([[view1.rel_many]]) END)) `__je_view1_rel_many` ON 1=1 WHERE ([[__je_view1_select_one.value]] > 1 AND [[__je_view1_select_one.value]] < 1 AND (([[__je_view1_select_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_view1_select_many.value]] as [[multiMatchValue]] FROM `view1` `__mm_view1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_view1.select_many]]) AND json_type([[__mm_view1.select_many]]) = 'array' THEN [[__mm_view1.select_many]] ELSE json_array([[__mm_view1.select_many]]) END)) `__je___mm_view1_select_many` ON 1=1 WHERE `__mm_view1`.`id` = `view1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__je_view1_select_many.value]] < 1 AND [[__je_view1_file_one.value]] > 1 AND [[__je_view1_file_one.value]] < 1 AND (([[__je_view1_file_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_view1_file_many.value]] as [[multiMatchValue]] FROM `view1` `__mm_view1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_view1.file_many]]) AND json_type([[__mm_view1.file_many]]) = 'array' THEN [[__mm_view1.file_many]] ELSE json_array([[__mm_view1.file_many]]) END)) `__je___mm_view1_file_many` ON 1=1 WHERE `__mm_view1`.`id` = `view1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__je_view1_file_many.value]] < 1 AND [[__je_view1_rel_one.value]] > 1 AND [[__je_view1_rel_one.value]] < 1 AND (([[__je_view1_rel_many.value]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_view1_rel_many.value]] as [[multiMatchValue]] FROM `view1` `__mm_view1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_view1.rel_many]]) AND json_type([[__mm_view1.rel_many]]) = 'array' THEN [[__mm_view1.rel_many]] ELSE json_array([[__mm_view1.rel_many]]) END)) `__je___mm_view1_rel_many` ON 1=1 WHERE `__mm_view1`.`id` = `view1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1)))) AND [[__je_view1_rel_many.value]] < 1)",
		},
		{
			...
			false,
			"SELECT DISTINCT `demo1`.* FROM `demo1` LEFT JOIN json_each((CASE WHEN json_valid([[demo1.select_one]]) AND json_type([[demo1.select_one]]) = 'array' THEN [[demo1.select_one]] ELSE json_array([[demo1.select_one]]) END)) `__je_demo1_select_one` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid([[demo1.select_many]]) AND json_type([[demo1.select_many]]) = 'array' THEN [[demo1.select_many]] ELSE json_array([[demo1.select_many]]) END)) `__je_demo1_select_many` ON 1=1 LEFT JOIN json_each((CASE WHEN json_valid({:dataEachTEST}) AND json_type({:dataEachTEST}) = 'array' THEN {:dataEachTEST} ELSE json_array({:dataEachTEST}) END)) `__dataEach_je_select_many` ON 1=1 WHERE (((COALESCE([[__je_demo1_select_one.value]], '') IS DISTINCT FROM COALESCE([[__je_demo1_select_many.value]], '')) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_demo1_select_many.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.select_many]]) AND json_type([[__mm_demo1.select_many]]) = 'array' THEN [[__mm_demo1.select_many]] ELSE json_array([[__mm_demo1.select_many]]) END)) `__je___mm_demo1_select_many` ON 1=1 WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT (COALESCE([[__je_demo1_select_one.value]], '') IS DISTINCT FROM COALESCE([[__smTEST.multiMatchValue]], ''))))) AND (([[__je_demo1_select_many.value]] > [[__je_demo1_select_one.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_demo1_select_many.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.select_many]]) AND json_type([[__mm_demo1.select_many]]) = 'array' THEN [[__mm_demo1.select_many]] ELSE json_array([[__mm_demo1.select_many]]) END)) `__je___mm_demo1_select_many` ON 1=1 WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > [[__je_demo1_select_one.value]])))) AND [[__je_demo1_select_many.value]] < [[__je_demo1_select_one.value]] AND (([[__je_demo1_select_many.value]] = [[__dataEach_je_select_many.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_demo1_select_many.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.select_many]]) AND json_type([[__mm_demo1.select_many]]) = 'array' THEN [[__mm_demo1.select_many]] ELSE json_array([[__mm_demo1.select_many]]) END)) `__je___mm_demo1_select_many` ON 1=1 WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mlTEST}} LEFT JOIN (SELECT [[__mm___dataEach_je_select_many.value]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid({:mmdataEachTEST}) AND json_type({:mmdataEachTEST}) = 'array' THEN {:mmdataEachTEST} ELSE json_array({:mmdataEachTEST}) END)) `__mm___dataEach_je_select_many` ON 1=1 WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mrTEST}} ON 1=1 WHERE NOT (COALESCE([[__mlTEST.multiMatchValue]], '') = COALESCE([[__mrTEST.multiMatchValue]], ''))))))",
		},
		{
		...
		},
		{
			...
			"rel_many.rel.active != rel_many.name &&" +
				...
				"rel_many.verified > @request.body.rel_many.verified",
			true,
			"SELECT DISTINCT `demo1`.* FROM `demo1` LEFT JOIN json_each((CASE WHEN json_valid([[demo1.rel_many]]) AND json_type([[demo1.rel_many]]) = 'array' THEN [[demo1.rel_many]] ELSE json_array([[demo1.rel_many]]) END)) `__je_demo1_rel_many` ON 1=1 LEFT JOIN `users` `demo1_rel_many` ON [[demo1_rel_many.id]] = [[__je_demo1_rel_many.value]] LEFT JOIN `demo2` `demo1_rel_many_rel` ON [[demo1_rel_many_rel.id]] = [[demo1_rel_many.rel]] LEFT JOIN `demo1` `demo1_rel_one` ON [[demo1_rel_one.id]] = [[demo1.rel_one]] LEFT JOIN `demo2` `__collection_demo2` ON 1=1 LEFT JOIN `users` `__data_users_rel_many` ON [[__data_users_rel_many.id]] IN ({:p0}, {:p1}) WHERE (((COALESCE([[demo1_rel_many_rel.active]], '') IS DISTINCT FROM COALESCE([[demo1_rel_many.name]], '')) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many_rel.active]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.rel_many]]) AND json_type([[__mm_demo1.rel_many]]) = 'array' THEN [[__mm_demo1.rel_many]] ELSE json_array([[__mm_demo1.rel_many]]) END)) `__mm_demo1_rel_many_je` ON 1=1 LEFT JOIN `users` `__mm_demo1_rel_many` ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] LEFT JOIN `demo2` `__mm_demo1_rel_many_rel` ON [[__mm_demo1_rel_many_rel.id]] = [[__mm_demo1_rel_many.rel]] WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mlTEST}} LEFT JOIN (SELECT [[__mm_demo1_rel_many.name]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.rel_many]]) AND json_type([[__mm_demo1.rel_many]]) = 'array' THEN [[__mm_demo1.rel_many]] ELSE json_array([[__mm_demo1.rel_many]]) END)) `__mm_demo1_rel_many_je` ON 1=1 LEFT JOIN `users` `__mm_demo1_rel_many` ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mrTEST}} ON 1=1 WHERE NOT (COALESCE([[__mlTEST.multiMatchValue]], '') IS DISTINCT FROM COALESCE([[__mrTEST.multiMatchValue]], ''))))) AND COALESCE([[demo1_rel_many_rel.active]], '') = COALESCE([[demo1_rel_many.name]], '') AND (([[demo1_rel_many_rel.title]] LIKE ('%' || [[demo1_rel_one.email]] || '%') ESCAPE '\\') AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many_rel.title]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.rel_many]]) AND json_type([[__mm_demo1.rel_many]]) = 'array' THEN [[__mm_demo1.rel_many]] ELSE json_array([[__mm_demo1.rel_many]]) END)) `__mm_demo1_rel_many_je` ON 1=1 LEFT JOIN `users` `__mm_demo1_rel_many` ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] LEFT JOIN `demo2` `__mm_demo1_rel_many_rel` ON [[__mm_demo1_rel_many_rel.id]] = [[__mm_demo1_rel_many.rel]] WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] LIKE ('%' || [[demo1_rel_one.email]] || '%') ESCAPE '\\')))) AND ((COALESCE([[__collection_demo2.active]], '') = COALESCE([[demo1_rel_many_rel.active]], '')) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___collection_demo2.active]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN `demo2` `__mm___collection_demo2` ON 1=1 WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mlTEST}} LEFT JOIN (SELECT [[__mm_demo1_rel_many_rel.active]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.rel_many]]) AND json_type([[__mm_demo1.rel_many]]) = 'array' THEN [[__mm_demo1.rel_many]] ELSE json_array([[__mm_demo1.rel_many]]) END)) `__mm_demo1_rel_many_je` ON 1=1 LEFT JOIN `users` `__mm_demo1_rel_many` ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] LEFT JOIN `demo2` `__mm_demo1_rel_many_rel` ON [[__mm_demo1_rel_many_rel.id]] = [[__mm_demo1_rel_many.rel]] WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mrTEST}} ON 1=1 WHERE NOT (COALESCE([[__mlTEST.multiMatchValue]], '') = COALESCE([[__mrTEST.multiMatchValue]], ''))))) AND COALESCE([[__collection_demo2.active]], '') = COALESCE([[demo1_rel_many_rel.active]], '') AND (([[demo1_rel_many.verified]] > [[__data_users_rel_many.verified]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many.verified]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo1.rel_many]]) AND json_type([[__mm_demo1.rel_many]]) = 'array' THEN [[__mm_demo1.rel_many]] ELSE json_array([[__mm_demo1.rel_many]]) END)) `__mm_demo1_rel_many_je` ON 1=1 LEFT JOIN `users` `__mm_demo1_rel_many` ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mlTEST}} LEFT JOIN (SELECT [[__mm___data_users_rel_many.verified]] as [[multiMatchValue]] FROM `demo1` `__mm_demo1` LEFT JOIN `users` `__mm___data_users_rel_many` ON [[__mm___data_users_rel_many.id]] IN ({:p2}, {:p3}) WHERE `__mm_demo1`.`id` = `demo1`.`id`) {{__mrTEST}} ON 1=1 WHERE NOT ([[__mlTEST.multiMatchValue]] > [[__mrTEST.multiMatchValue]])))))",
		},
		{
		...
		},
		{
			...
			true,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo4` `__data_demo4_self_rel_one` ON [[__data_demo4_self_rel_one.id]]={:p0} LEFT JOIN `demo3` `__data_demo3_rel_many_cascade` ON [[__data_demo3_rel_many_cascade.id]] IN ({:p1}, {:p2}) LEFT JOIN `demo3` `__data_demo3_rel_one_cascade` ON [[__data_demo3_rel_one_cascade.id]]={:p3} LEFT JOIN `demo4` `demo4_self_rel_one` ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN json_each((CASE WHEN json_valid([[demo4_self_rel_one.rel_many_cascade]]) AND json_type([[demo4_self_rel_one.rel_many_cascade]]) = 'array' THEN [[demo4_self_rel_one.rel_many_cascade]] ELSE json_array([[demo4_self_rel_one.rel_many_cascade]]) END)) `__je_demo4_self_rel_one_rel_many_cascade` ON 1=1 LEFT JOIN `demo3` `demo4_self_rel_one_rel_many_cascade` ON [[demo4_self_rel_one_rel_many_cascade.id]] = [[__je_demo4_self_rel_one_rel_many_cascade.value]] WHERE (json_array_length(CASE WHEN json_valid([[__data_demo4_self_rel_one.self_rel_many]]) AND json_type([[__data_demo4_self_rel_one.self_rel_many]]) = 'array' THEN [[__data_demo4_self_rel_one.self_rel_many]] ELSE (CASE WHEN [[__data_demo4_self_rel_one.self_rel_many]] = '' OR [[__data_demo4_self_rel_one.self_rel_many]] IS NULL THEN json_array() ELSE json_array([[__data_demo4_self_rel_one.self_rel_many]]) END) END) > {:TEST} AND json_array_length(CASE WHEN json_valid([[__data_demo4_self_rel_one.self_rel_many]]) AND json_type([[__data_demo4_self_rel_one.self_rel_many]]) = 'array' THEN [[__data_demo4_self_rel_one.self_rel_many]] ELSE (CASE WHEN [[__data_demo4_self_rel_one.self_rel_many]] = '' OR [[__data_demo4_self_rel_one.self_rel_many]] IS NULL THEN json_array() ELSE json_array([[__data_demo4_self_rel_one.self_rel_many]]) END) END) > {:TEST} AND json_array_length(CASE WHEN json_valid([[__data_demo3_rel_many_cascade.files]]) AND json_type([[__data_demo3_rel_many_cascade.files]]) = 'array' THEN [[__data_demo3_rel_many_cascade.files]] ELSE (CASE WHEN [[__data_demo3_rel_many_cascade.files]] = '' OR [[__data_demo3_rel_many_cascade.files]] IS NULL THEN json_array() ELSE json_array([[__data_demo3_rel_many_cascade.files]]) END) END) < {:TEST} AND ((json_array_length(CASE WHEN json_valid([[__data_demo3_rel_many_cascade.files]]) AND json_type([[__data_demo3_rel_many_cascade.files]]) = 'array' THEN [[__data_demo3_rel_many_cascade.files]] ELSE (CASE WHEN [[__data_demo3_rel_many_cascade.files]] = '' OR [[__data_demo3_rel_many_cascade.files]] IS NULL THEN json_array() ELSE json_array([[__data_demo3_rel_many_cascade.files]]) END) END) < {:TEST}) AND (NOT EXISTS (SELECT 1 FROM (SELECT json_array_length(CASE WHEN json_valid([[__mm___data_demo3_rel_many_cascade.files]]) AND json_type([[__mm___data_demo3_rel_many_cascade.files]]) = 'array' THEN [[__mm___data_demo3_rel_many_cascade.files]] ELSE (CASE WHEN [[__mm___data_demo3_rel_many_cascade.files]] = '' OR [[__mm___data_demo3_rel_many_cascade.files]] IS NULL THEN json_array() ELSE json_array([[__mm___data_demo3_rel_many_cascade.files]]) END) END) as [[multiMatchValue]] FROM `demo4` `__mm_demo4` LEFT JOIN `demo3` `__mm___data_demo3_rel_many_cascade` ON [[__mm___data_demo3_rel_many_cascade.id]] IN ({:p8}, {:p9}) WHERE `__mm_demo4`.`id` = `demo4`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] < {:TEST})))) AND json_array_length(CASE WHEN json_valid([[__data_demo3_rel_one_cascade.files]]) AND json_type([[__data_demo3_rel_one_cascade.files]]) = 'array' THEN [[__data_demo3_rel_one_cascade.files]] ELSE (CASE WHEN [[__data_demo3_rel_one_cascade.files]] = '' OR [[__data_demo3_rel_one_cascade.files]] IS NULL THEN json_array() ELSE json_array([[__data_demo3_rel_one_cascade.files]]) END) END) < {:TEST} AND json_array_length(CASE WHEN json_valid([[demo4_self_rel_one.self_rel_many]]) AND json_type([[demo4_self_rel_one.self_rel_many]]) = 'array' THEN [[demo4_self_rel_one.self_rel_many]] ELSE (CASE WHEN [[demo4_self_rel_one.self_rel_many]] = '' OR [[demo4_self_rel_one.self_rel_many]] IS NULL THEN json_array() ELSE json_array([[demo4_self_rel_one.self_rel_many]]) END) END) = {:TEST} AND json_array_length(CASE WHEN json_valid([[demo4_self_rel_one.self_rel_many]]) AND json_type([[demo4_self_rel_one.self_rel_many]]) = 'array' THEN [[demo4_self_rel_one.self_rel_many]] ELSE (CASE WHEN [[demo4_self_rel_one.self_rel_many]] = '' OR [[demo4_self_rel_one.self_rel_many]] IS NULL THEN json_array() ELSE json_array([[demo4_self_rel_one.self_rel_many]]) END) END) = {:TEST} AND ((json_array_length(CASE WHEN json_valid([[demo4_self_rel_one_rel_many_cascade.files]]) AND json_type([[demo4_self_rel_one_rel_many_cascade.files]]) = 'array' THEN [[demo4_self_rel_one_rel_many_cascade.files]] ELSE (CASE WHEN [[demo4_self_rel_one_rel_many_cascade.files]] = '' OR [[demo4_self_rel_one_rel_many_cascade.files]] IS NULL THEN json_array() ELSE json_array([[demo4_self_rel_one_rel_many_cascade.files]]) END) END) IS DISTINCT FROM {:TEST}) AND (NOT EXISTS (SELECT 1 FROM (SELECT json_array_length(CASE WHEN json_valid([[__mm_demo4_self_rel_one_rel_many_cascade.files]]) AND json_type([[__mm_demo4_self_rel_one_rel_many_cascade.files]]) = 'array' THEN [[__mm_demo4_self_rel_one_rel_many_cascade.files]] ELSE (CASE WHEN [[__mm_demo4_self_rel_one_rel_many_cascade.files]] = '' OR [[__mm_demo4_self_rel_one_rel_many_cascade.files]] IS NULL THEN json_array() ELSE json_array([[__mm_demo4_self_rel_one_rel_many_cascade.files]]) END) END) as [[multiMatchValue]] FROM `demo4` `__mm_demo4` LEFT JOIN `demo4` `__mm_demo4_self_rel_one` ON [[__mm_demo4_self_rel_one.id]] = [[__mm_demo4.self_rel_one]] LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo4_self_rel_one.rel_many_cascade]]) AND json_type([[__mm_demo4_self_rel_one.rel_many_cascade]]) = 'array' THEN [[__mm_demo4_self_rel_one.rel_many_cascade]] ELSE json_array([[__mm_demo4_self_rel_one.rel_many_cascade]]) END)) `__mm_demo4_self_rel_one_rel_many_cascade_je` ON 1=1 LEFT JOIN `demo3` `__mm_demo4_self_rel_one_rel_many_cascade` ON [[__mm_demo4_self_rel_one_rel_many_cascade.id]] = [[__mm_demo4_self_rel_one_rel_many_cascade_je.value]] WHERE `__mm_demo4`.`id` = `demo4`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] IS DISTINCT FROM {:TEST})))) AND json_array_length(CASE WHEN json_valid([[demo4_self_rel_one_rel_many_cascade.files]]) AND json_type([[demo4_self_rel_one_rel_many_cascade.files]]) = 'array' THEN [[demo4_self_rel_one_rel_many_cascade.files]] ELSE (CASE WHEN [[demo4_self_rel_one_rel_many_cascade.files]] = '' OR [[demo4_self_rel_one_rel_many_cascade.files]] IS NULL THEN json_array() ELSE json_array([[demo4_self_rel_one_rel_many_cascade.files]]) END) END) IS DISTINCT FROM {:TEST})",
		},
		{
		...
		},
		{
			...
			true,
			"SELECT `demo1`.* FROM `demo1` WHERE ((TRUE = 1 AND {:TEST} IS DISTINCT FROM [[demo1.number]]) IS NOT DISTINCT FROM 0 AND (FALSE = 1 AND ('' IS DISTINCT FROM [[demo1.email]] AND [[demo1.email]] IS NOT NULL)) IS NOT DISTINCT FROM 1 AND (TRUE = 1 AND {:TEST} IS DISTINCT FROM [[demo1.number]]) IS NOT DISTINCT FROM (TRUE = 1 AND {:TEST} IS DISTINCT FROM [[demo1.select_many]]))",
		},
		{
			...
			false,
			"SELECT `demo4`.* FROM `demo4` WHERE ((CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$.a.b') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base.a.b') END) IS NOT DISTINCT FROM {:TEST} AND json_array_length(CASE WHEN json_valid([[demo4.self_rel_many]]) AND json_type([[demo4.self_rel_many]]) = 'array' THEN [[demo4.self_rel_many]] ELSE (CASE WHEN [[demo4.self_rel_many]] = '' OR [[demo4.self_rel_many]] IS NULL THEN json_array() ELSE json_array([[demo4.self_rel_many]]) END) END) IS DISTINCT FROM {:TEST} AND (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$.a.b') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base.a.b') END) > {:TEST} AND json_array_length(CASE WHEN json_valid([[demo4.self_rel_many]]) AND json_type([[demo4.self_rel_many]]) = 'array' THEN [[demo4.self_rel_many]] ELSE (CASE WHEN [[demo4.self_rel_many]] = '' OR [[demo4.self_rel_many]] IS NULL THEN json_array() ELSE json_array([[demo4.self_rel_many]]) END) END) <= {:TEST})",
		},
		{
			...
			false,
			"SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN json_each((CASE WHEN json_valid([[demo4.self_rel_many]]) AND json_type([[demo4.self_rel_many]]) = 'array' THEN [[demo4.self_rel_many]] ELSE json_array([[demo4.self_rel_many]]) END)) `__je_demo4_self_rel_many` ON 1=1 LEFT JOIN `demo4` `demo4_self_rel_many` ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] WHERE ((CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS NOT DISTINCT FROM {:TEST} OR (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS DISTINCT FROM {:TEST} OR {:TEST} IS NOT DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR {:TEST} IS DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS NOT DISTINCT FROM NULL OR (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS DISTINCT FROM NULL OR NULL IS NOT DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR NULL IS DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS NOT DISTINCT FROM 1 OR (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS DISTINCT FROM 1 OR 1 IS NOT DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR 1 IS DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS NOT DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) IS NOT DISTINCT FROM [[demo4.title]] OR [[demo4.title]] IS DISTINCT FROM (CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base') END) OR (((CASE WHEN json_valid([[demo4_self_rel_many.json_object]]) THEN JSON_EXTRACT([[demo4_self_rel_many.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4_self_rel_many.json_object]]), '$.base') END) IS NOT DISTINCT FROM {:TEST}) AND (NOT EXISTS (SELECT 1 FROM (SELECT (CASE WHEN json_valid([[__mm_demo4_self_rel_many.json_object]]) THEN JSON_EXTRACT([[__mm_demo4_self_rel_many.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[__mm_demo4_self_rel_many.json_object]]), '$.base') END) as [[multiMatchValue]] FROM `demo4` `__mm_demo4` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo4.self_rel_many]]) AND json_type([[__mm_demo4.self_rel_many]]) = 'array' THEN [[__mm_demo4.self_rel_many]] ELSE json_array([[__mm_demo4.self_rel_many]]) END)) `__mm_demo4_self_rel_many_je` ON 1=1 LEFT JOIN `demo4` `__mm_demo4_self_rel_many` ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE `__mm_demo4`.`id` = `demo4`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] IS NOT DISTINCT FROM {:TEST})))) OR ((NULL IS NOT DISTINCT FROM (CASE WHEN json_valid([[demo4_self_rel_many.json_object]]) THEN JSON_EXTRACT([[demo4_self_rel_many.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4_self_rel_many.json_object]]), '$.base') END)) AND (NOT EXISTS (SELECT 1 FROM (SELECT (CASE WHEN json_valid([[__mm_demo4_self_rel_many.json_object]]) THEN JSON_EXTRACT([[__mm_demo4_self_rel_many.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[__mm_demo4_self_rel_many.json_object]]), '$.base') END) as [[multiMatchValue]] FROM `demo4` `__mm_demo4` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo4.self_rel_many]]) AND json_type([[__mm_demo4.self_rel_many]]) = 'array' THEN [[__mm_demo4.self_rel_many]] ELSE json_array([[__mm_demo4.self_rel_many]]) END)) `__mm_demo4_self_rel_many_je` ON 1=1 LEFT JOIN `demo4` `__mm_demo4_self_rel_many` ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE `__mm_demo4`.`id` = `demo4`.`id`) {{__smTEST}} WHERE NOT (NULL IS NOT DISTINCT FROM [[__smTEST.multiMatchValue]])))) OR (((CASE WHEN json_valid([[demo4_self_rel_many.json_object]]) THEN JSON_EXTRACT([[demo4_self_rel_many.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4_self_rel_many.json_object]]), '$.base') END) IS NOT DISTINCT FROM (CASE WHEN json_valid([[demo4_self_rel_many.json_object]]) THEN JSON_EXTRACT([[demo4_self_rel_many.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[demo4_self_rel_many.json_object]]), '$.base') END)) AND (NOT EXISTS (SELECT 1 FROM (SELECT (CASE WHEN json_valid([[__mm_demo4_self_rel_many.json_object]]) THEN JSON_EXTRACT([[__mm_demo4_self_rel_many.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[__mm_demo4_self_rel_many.json_object]]), '$.base') END) as [[multiMatchValue]] FROM `demo4` `__mm_demo4` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo4.self_rel_many]]) AND json_type([[__mm_demo4.self_rel_many]]) = 'array' THEN [[__mm_demo4.self_rel_many]] ELSE json_array([[__mm_demo4.self_rel_many]]) END)) `__mm_demo4_self_rel_many_je` ON 1=1 LEFT JOIN `demo4` `__mm_demo4_self_rel_many` ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE `__mm_demo4`.`id` = `demo4`.`id`) {{__mlTEST}} LEFT JOIN (SELECT (CASE WHEN json_valid([[__mm_demo4_self_rel_many.json_object]]) THEN JSON_EXTRACT([[__mm_demo4_self_rel_many.json_object]], '$') ELSE JSON_EXTRACT(json_object('base', [[__mm_demo4_self_rel_many.json_object]]), '$.base') END) as [[multiMatchValue]] FROM `demo4` `__mm_demo4` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo4.self_rel_many]]) AND json_type([[__mm_demo4.self_rel_many]]) = 'array' THEN [[__mm_demo4.self_rel_many]] ELSE json_array([[__mm_demo4.self_rel_many]]) END)) `__mm_demo4_self_rel_many_je` ON 1=1 LEFT JOIN `demo4` `__mm_demo4_self_rel_many` ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE `__mm_demo4`.`id` = `demo4`.`id`) {{__mrTEST}} ON 1=1 WHERE NOT ([[__mlTEST.multiMatchValue]] IS NOT DISTINCT FROM [[__mrTEST.multiMatchValue]])))))",
		},
		{
			...
			false,
			"SELECT `view1`.* FROM `view1` WHERE (([[view1.point]] = '' OR [[view1.point]] IS NULL) OR (CASE WHEN json_valid([[view1.point]]) THEN JSON_EXTRACT([[view1.point]], '$.lat') ELSE JSON_EXTRACT(json_object('base', [[view1.point]]), '$.base.lat') END) > {:TEST} OR (CASE WHEN json_valid([[view1.point]]) THEN JSON_EXTRACT([[view1.point]], '$.lon') ELSE JSON_EXTRACT(json_object('base', [[view1.point]]), '$.base.lon') END) < {:TEST} OR (CASE WHEN json_valid([[view1.point]]) THEN JSON_EXTRACT([[view1.point]], '$.something') ELSE JSON_EXTRACT(json_object('base', [[view1.point]]), '$.base.something') END) > {:TEST})",
		},
		{
		...
		},
		{
			...
			false,
			"SELECT DISTINCT `demo5`.* FROM `demo5` LEFT JOIN json_each((CASE WHEN json_valid([[demo5.rel_many]]) AND json_type([[demo5.rel_many]]) = 'array' THEN [[demo5.rel_many]] ELSE json_array([[demo5.rel_many]]) END)) `__je_demo5_rel_many` ON 1=1 LEFT JOIN `demo4` `demo5_rel_many` ON [[demo5_rel_many.id]] = [[__je_demo5_rel_many.value]] WHERE (((strftime({:TEST},[[demo5_rel_many.created]]) = 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT strftime({:TEST},[[__mm_demo5_rel_many.created]]) as [[multiMatchValue]] FROM `demo5` `__mm_demo5` LEFT JOIN json_each((CASE WHEN json_valid([[__mm_demo5.rel_many]]) AND json_type([[__mm_demo5.rel_many]]) = 'array' THEN [[__mm_demo5.rel_many]] ELSE json_array([[__mm_demo5.rel_many]]) END)) `__mm_demo5_rel_many_je` ON 1=1 LEFT JOIN `demo4` `__mm_demo5_rel_many` ON [[__mm_demo5_rel_many.id]] = [[__mm_demo5_rel_many_je.value]] WHERE `__mm_demo5`.`id` = `demo5`.`id`) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = 1)))))",
		},
	}
...
func TestRecordFieldResolverResolveCollectionFields(t *testing.T) {
	...
	scenarios := []struct {
		...
		// json_extract
		{"json_array.0", false, "(CASE WHEN json_valid([[demo4.json_array]]) THEN JSON_EXTRACT([[demo4.json_array]], '$[0]') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_array]]), '$.base[0]') END)"},
		{"json_object.a.b.c", false, "(CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$.a.b.c') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base.a.b.c') END)"},

		// max relations limit shouldn't apply for json paths
		{"json_object.a.b.c.e.f.g.h.i.j.k.l.m.n.o.p", false, "(CASE WHEN json_valid([[demo4.json_object]]) THEN JSON_EXTRACT([[demo4.json_object]], '$.a.b.c.e.f.g.h.i.j.k.l.m.n.o.p') ELSE JSON_EXTRACT(json_object('base', [[demo4.json_object]]), '$.base.a.b.c.e.f.g.h.i.j.k.l.m.n.o.p') END)"},
