...
<div class="content txt-lg m-b-sm">
    ...
    <p>
        ...
        in <code>base.authStore</code> is still valid and up-to-date.
    </p>
</div>
...
<SdkTabs
    js={`
        ...
        const authData = await base.collection('${collection?.name}').authRefresh();
    ...
    dart={`
        ...
        final authData = await base.collection('${collection?.name}').authRefresh();
