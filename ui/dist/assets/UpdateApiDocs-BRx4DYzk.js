...
const record = await base.collection('${(ct=d[0])==null?void 0:ct.name}').update('RECORD_ID', data);
    `,dart:`
...
final record = await base.collection('${(ut=d[0])==null?void 0:ut.name}').update('RECORD_ID', body: body);
