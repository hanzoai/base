...
func defaultBaseConfig() *BaseConfig {
	return &BaseConfig{
		...
		Envs: map[string]EnvConfig{
			...
			"dev": {
				ATSURL: "https://ats.dev.example.internal",
				BDURL:  "https://bd.dev.example.internal",
				TAURL:  "https://ta.dev.example.internal",
				IAMURL: "https://iam.dev.example.internal",
			},
			"test": {
				ATSURL: "https://ats.test.example.internal",
				BDURL:  "https://bd.test.example.internal",
				TAURL:  "https://ta.test.example.internal",
				IAMURL: "https://iam.test.example.internal",
			},
			"main": {
				ATSURL: "https://ats.example.internal",
				BDURL:  "https://bd.example.internal",
				TAURL:  "https://ta.example.internal",
				IAMURL: "https://iam.example.internal",
			},
		},
		DefaultOrg: "mlc",
