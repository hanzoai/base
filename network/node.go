...
// we cross-feed it into our local shard engine so every member converges.
//
...
// value). If the two disagree the envelope is malformed or hostile; drop it,
// bump the rejection metric, and return. This closes the cross-shard
// state-injection probe.
